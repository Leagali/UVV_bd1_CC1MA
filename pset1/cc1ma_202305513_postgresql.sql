...
--Deletar um schema caso exista um com o mesmo nome--
...
ADD CONSTRAINT status_check CHECK (status IN ('CRIADO', 'ENVIADO', 'TRANSITO', 'ENTREGUE'));
...
--Criar constraint de checagem para verificar os status do produto--

ALTER TABLE lojas.pedidos
ADD CONSTRAINT status_check CHECK (status IN ('CANCELADO','COMPLETO','ABERTO','PAGO','REEMBOLSADO','ENVIADO'));
